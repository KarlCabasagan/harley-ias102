...
<html>
  <head>
    ...
    <body style="font-family: sans-serif;">
        <div style="display: block; margin: auto; max-width: 600px; padding: 20px; background: #1a1a2e; color: #fef3c7;">
            <h1 style="font-size: 20px; color: #f97316;">Security Verification</h1>
            <p>Your one-time verification code is:</p>
            <div style="font-size: 32px; font-weight: bold; margin: 25px 0; color: #facc15;">$otp</div>
            <p>This code will expire in 5 minutes.</p>
            <p style="color: #ef4444;">If you didn't request this code, please secure your account.</p>
        </div>
    </body>
</html>
HTML;
    ...
    $emailContent = <<<EOF
From: IAS102 Test Mail <{$fromEmail}>
To: <{$recipientEmail}>
Subject: {$subject}
MIME-Version: 1.0
