        ...
        const activityChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        fill: true,
                        backgroundColor: 'rgba(249, 115, 22, 0.2)',         // soft orange fill
                        borderColor: 'rgba(249, 115, 22, 1)',                // vibrant orange line
                        tension: 0.4,
                        pointBackgroundColor: 'rgba(249, 115, 22, 1)',       // orange points
                        pointBorderColor: '#fff',
                        pointHoverBackgroundColor: '#fff',
                        pointHoverBorderColor: 'rgba(249, 115, 22, 1)'       // hover outline
                    },
                    {
                        label: 'Security Score',
                        data: [28, 48, 40, 45, 76, 65, 50],
                        fill: true,
                        backgroundColor: 'rgba(251, 191, 36, 0.2)',            // amber/yellow-orange
                        borderColor: 'rgba(251, 191, 36, 1)',                   // bold amber
                        tension: 0.4,
