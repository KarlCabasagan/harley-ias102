...
<head>
    ...
    <style>
        :root {
            ...
            --dashboard-surface: #1e293b;          /* surface panel */
            --dashboard-text: #fef3c7;             /* warm light text */
            --dashboard-text-secondary: #fcd34d;   /* soft golden secondary */
            --dashboard-error: #ef4444;            /* red for errors */
            --dashboard-success: #10b981;          /* green for success */
            --dashboard-border: #f97316;           /* themed orange border */
        }
        ...
        .container {
            background: rgba(30, 41, 59, 0.85); /* slightly more opaque for better contrast */
            border: 1px solid var(--dashboard-primary); /* orange border */
            border-radius: 12px;
            padding: 40px;
            box-shadow: 0 0 20px rgba(249, 115, 22, 0.3); /* soft orange glow */
            width: 100%;
            max-width: 400px;
            text-align: center;
        }
